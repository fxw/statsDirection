...
var direction;
var initializeAller;
var initializeRetour;

initializeAller = function() {
 document.getElementById('origin').value = "48.818308,2.2353415";
  document.getElementById('destination').value = "48.723893,2.2692611";

};

initializeRetour = function() {
 document.getElementById('destination').value = "48.818308,2.2353415";
  document.getElementById('origin').value = "48.723893,2.2692611";

};
initialize = function(){
  var latLng = new google.maps.LatLng(48.818308,2.2353415); // Correspond au coordonnées de meudon
  
  //48.723893,2.2692611 ==> Massy  
  var myOptions = {
